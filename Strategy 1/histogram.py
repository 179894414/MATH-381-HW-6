...
#Store wining probability for player 1
...
for i in range(1000000): # play 1000000 games
    ...
    #count number of wining for both players
    ...
    #calculate the average probability every 1000 game
    if ((i!= 0) and ((i+1) % 1000 == 0)):
            wining_p1.append(win_count1/1000)
            wining_p2.append(win_count2/1000)
            win_count1 = 0
            win_count2 = 0
...
plt.hist(wining_p1,density=True,bins=15)
plt.ylabel('frequency')
plt.xlabel('wining probability for player 1')
